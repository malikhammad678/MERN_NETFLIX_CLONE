    ...
    return (
        <div className='bg-hero min-h-screen relative'>
            <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
                <img src='/netflix-logo.png' alt='Netflix Logo' className='w-36' />
                <Link to={"/signup"} className='text-white bg-red-600 py-2 px-4 text-[18px] rounded'>
                    Sign Up
                </Link>
            </header>
            <motion.div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'
            ...
            >
                ...
                <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleSubmit}>
                    <input
                        ...
                        className='p-2 rounded flex-1 bg-black/80 border border-gray-500  focus:outline-none'
                        value={email}
