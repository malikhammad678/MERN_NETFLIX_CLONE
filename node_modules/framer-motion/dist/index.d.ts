...
declare abstract class VisualElement<Instance = unknown, RenderState = unknown, Options extends {} = {}> {
     ...
     */
    abstract build(renderState: RenderState, latestValues: ResolvedValues$1, props: MotionProps): void;
    /**
 ...
 */
declare function createRendererMotionComponent<Props extends {}, Instance, RenderState>({ preloadedFeatures, createVisualElement, useRender, useVisualState, Component, }: MotionComponentConfig<Instance, RenderState>): React$1.ForwardRefExoticComponent<React$1.PropsWithoutRef<MotionComponentProps<Props>> & React$1.RefAttributes<Instance>>;
 ...
 */
declare function buildTransform(latestValues: ResolvedValues$1, transform: HTMLRenderState["transform"], transformTemplate?: MotionProps["transformTemplate"]): string;
