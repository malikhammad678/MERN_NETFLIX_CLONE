...
import * as namespace from '../../render/components/motion/namespace.mjs';

function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
    const Component = useConstant(() => namespace[as]);
    const order = [];
...
const ReorderGroup = forwardRef(ReorderGroupComponent);
